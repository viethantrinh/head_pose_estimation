...
from model.bi_directional_cross_attention.ca_model_neighborhood_stable_light import Model
...
class Processor:
    ...
    def load_data(self):
        ...
        dataset_map = {
            'BIWI_train': dataset.BIWI_train,
            'BIWI_test': dataset.BIWI_test
        }
    ...
    def eval(self, epoch, loader_name=['test1']):
        self.model.eval()
        self.print_log(
            "======================================================================================")
