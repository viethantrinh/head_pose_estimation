...
class Model(nn.Module):
    """
    Enhanced model with:
    - T1: Gate mechanism after soft attention in fusion layer
    - T2: GLU-based prediction heads instead of standard FC layers
    """
    def __init__(self):
        ...
        # T2: GLU-based prediction heads instead of simple Linear layers
